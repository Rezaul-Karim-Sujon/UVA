...
ll check(ll counter, ll g)
{
    if(counter>g) return 2;
    return 1;
}
...
int main()
{
    ...
    for(;;)
    {
        ...
        //counter++;
        total=g+k;
        //cout << g << " " << k << " " << counter << endl;
        //cout << g << " " << k << endl;
    }
    cout << ((g==0)?"Keka":"Gared")<< endl;
    }
}
